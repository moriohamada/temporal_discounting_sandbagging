...
I ask whether models care _when_ a 'threat' (removal of an essential capability for a model's goals) is expected to be enacted, and how this influences their propensity to sandbag.

Short answer - there's some indication that sandbagging probability slightly increases with the proximity of the threat, in this paricular context. But definitely can't make strong general conclusions!
